...
# # Sort by Symbol (A-Z) and Date (newest first)
# merged_df.sort_values(by=['Symbol', 'Date'],
...
# print("\nMerging complete! Your file is downloading automatically.")
# print("File name:", output_filename)
# print("Total symbols processed:", merged_df['Symbol'].nunique())
# print("Total rows processed:", len(merged_df))
...
subprocess.run(["pip", "install", "nepse-scraper", "xlsxwriter", "gitpython", "pandas"], check=True)
...
# repo_dir = '/content/nepse/new/new179'  # New directory to clone the repository
...
# file_to_delete = 'nepse_automation.py'  # Replace with the file you want to delete
